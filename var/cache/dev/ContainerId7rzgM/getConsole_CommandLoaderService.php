...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'knp_gaufrette.command.filesystem_keys' => array('privates', 'knp_gaufrette.command.filesystem_keys', 'getKnpGaufrette_Command_FilesystemKeysService.php', true),
    ...
    'payum.command.create_capture_token' => array('privates', 'payum.command.create_capture_token', 'getPayum_Command_CreateCaptureTokenService.php', true),
    'payum.command.create_notify_token' => array('privates', 'payum.command.create_notify_token', 'getPayum_Command_CreateNotifyTokenService.php', true),
    'payum.command.debug_gateway' => array('privates', 'payum.command.debug_gateway', 'getPayum_Command_DebugGatewayService.php', true),
    'payum.command.status' => array('privates', 'payum.command.status', 'getPayum_Command_StatusService.php', true),
    ...
    'sensio_distribution.security_checker.command' => array('privates', 'sensio_distribution.security_checker.command', 'getSensioDistribution_SecurityChecker_CommandService.php', true),
