...
// Returns the public 'fos_elastica.listener.bitbag_option_taxons.default' shared service.
...
return $this->services['fos_elastica.listener.bitbag_option_taxons.default'] = new \FOS\ElasticaBundle\Doctrine\Listener(($this->services['fos_elastica.object_persister.bitbag_option_taxons.default'] ?? $this->load('getFosElastica_ObjectPersister_BitbagOptionTaxons_DefaultService.php')), ($this->privates['fos_elastica.indexable'] ?? $this->privates['fos_elastica.indexable'] = new \FOS\ElasticaBundle\Provider\Indexable(array())), array('identifier' => 'id', 'indexName' => 'bitbag_option_taxons', 'typeName' => 'default', 'defer' => true), ($this->privates['fos_elastica.logger'] ?? $this->getFosElastica_LoggerService()));
